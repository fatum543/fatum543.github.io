$(document).ready(function(){
    ...
    function valideForms(form) {
        $(form).validate({
            ...
            messages: {
                name: "Пожалуйста, давайте введём именно Ваше имя!",
                phone: "Телефончик должне быть нормальным",
                email: {
                  required: "Извините, но это совсем не email",
                  email: "Если Вы вдруг не знаете какой должен быть формат у email, то показываю: qwerty@mail.ru"
                }
              }
        });
